...
import { faCirclePlus, faEllipsis, faHouseChimney, faBarsProgress, faChartLine, faGears, faBars } from "@fortawesome/free-solid-svg-icons";
...
export default function Records(props: RecordsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute hover:text-[rgba(82,101,235,1)]">
      ...
      <div className="text-black text-left font-normal">
        <p className="h-6 absolute m-0 w-[147px] left-[222px] top-[31px] text-[29.54px] leading-[35.18446350097656px]">
          New Case
        </p>
        <button className="absolute text-[rgba(210,215,218,1)] hover:text-[rgba(82,101,235,1)] top-[37px] left-[440px] scale-150">
        <Link href="NewCase">
        <FontAwesomeIcon icon={faCirclePlus} />
        </Link>
        </button>
      </div>
      <button className="absolute text-[rgba(210,215,218,1)] hover:text-[rgba(82,101,235,1)]">
      <div className="absolute left-[38px] top-[236px] scale-125">
      <FontAwesomeIcon icon={faHouseChimney} />
      </div>
      <p className="absolute text-white hover:text-[rgba(82,101,235,1)] text-m left-[29px] top-[266px]">
        Home
      </p>
      </button>
      <button className="absolute text-[rgba(82,101,235,1)] hover:text-[rgba(82,101,235,1)]">
      <Link href="Records">
      <div className="absolute left-[38px] top-[336px] scale-125">

      <FontAwesomeIcon icon={faBarsProgress} />
      </div>
      <p className="absolute text-[rgba(82,101,235,1)] hover:text-[rgba(82,101,235,1)] text-m left-[20px] top-[366px]">
        Records
      </p>
      </Link>
      </button>
      ...
      <p className="absolute text-white hover:text-[rgba(82,101,235,1)] text-m left-[13px] top-[466px]">
      Dashboard
      </p>
      </button>
      ...
      <p className="absolute text-white hover:text-[rgba(82,101,235,1)] text-m left-[23px] top-[566px]">
      Settings
      </p>
      </button>
      ...
      <div className="text-black font-normal">
        <div className="absolute w-[1000px] h-[121px] left-[512px] top-[-17px]">
          ...
          <div className="absolute font-bold  font-['Roboto'] text-gray-400 transition-all left-[45.440%] top-[73.50%]  w-full h-[92px]">
                    {date}
           </div>

        <button className="absolute text-[rgba(210,215,218,1)] hover:text-[rgba(82,101,235,1)] scale-125 left-[88.4%] top-[45.67%]">
      ...
      <div>
        <div className="absolute rounded-full w-[60px] h-[60px] left-[967px] top-[223px] [background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/cca0a63b35d5723ef07aeff50790b04381f34d84.webp)_center_/_cover]" />
      </div>
      <div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[134px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      ...
      <div>
        <div className="absolute bg-white rounded-tl-[20px] rounded-tr-[20px] w-[434px] h-[169px] left-[527px] top-[147px] rounded-br-[20px] [box-shadow:0px_0px_0px_1px_rgba(82,_101,_235,_1)_inset] [box-shadow-width:1px]" />
      </div>
      <div className="text-black text-left font-light">
        <div className="h-5 absolute w-[57px] left-[973px] top-[279px]">
      ...
      <div>
        <div className="absolute rounded-tl-[20px] rounded-tr-[20px] w-[445px] h-[169px] left-[1050px] top-[362px] bg-[rgba(82,101,235,1)] rounded-bl-[20px] [box-shadow:0px_0px_0px_1px_white_inset] [box-shadow-width:1px]" />
      </div>
      <div className="text-black text-left font-light">
        <div className="h-5 absolute w-[57px] left-[979px] top-[501px]">
          <p className="inset-0 h-5 absolute m-0 w-[57px] text-[12.72px] leading-[29.440059661865234px]">
          <Clock/>
          </p>
        </div>
      ...
      <div>
        <div className="absolute rounded-full w-[60px] h-[60px] left-[972px] top-[444px] [background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/3d0446022f4d25960fff907bedf932d5aa3bd3f5.webp)_center_/_cover]" />
      </div>
      <div className="text-black text-left font-light">
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[250px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
        <div className="h-28 absolute w-[398px] left-[115px] top-[324px] bg-[rgba(82,101,235,1)] [box-shadow:0px_0px_0px_1px_rgba(210,_215,_218,_1)_inset] [box-shadow-width:1px]" />
      </div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[459px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[569px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[679px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[789px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
      ...
      <div className="text-black text-left font-normal">
        ...
        <button className="absolute text-[rgba(82,101,235,1)] scale-125 left-[442px] top-[901px]">
        <FontAwesomeIcon icon={faEllipsis} />
        </button>
      </div>
      <div>
        <div className="absolute w-[758px] h-[60px] left-[662px] top-[870px] bg-[rgba(82,101,235,1)] rounded-[20px]" />
      </div>
      ...
      <div>
        <div className="absolute bg-white rounded-tl-[20px] rounded-tr-[20px] w-[434px] h-[169px] left-[530px] top-[592px] rounded-br-[20px] [box-shadow:0px_0px_0px_1px_rgba(82,_101,_235,_1)_inset] [box-shadow-width:1px]" />
      </div>
      <div className="text-black text-left font-light">
        <div className="h-5 absolute w-[57px] left-[978px] top-[726px]">
          <p className="inset-0 h-5 absolute m-0 w-[57px] text-[12.72px] leading-[29.440059661865234px]">
          <Clock/>
          </p>
        </div>
      ...
      <div>
        <div className="absolute rounded-full w-[60px] h-[60px] left-[973px] top-[667px] [background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/18422d644eebc90ebbd9ecd000457b954cd61943.webp)_center_/_cover]" />
      </div>
    </div>
  );
}
